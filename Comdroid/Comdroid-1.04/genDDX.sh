...
LOC=$1
INSTALLDIR="/home/sx2151/undergradproj/Comdroid/Comdroid-1.04"
if [ -z $1 ]
then
...
# $INSTALLDIR/intentanalysis.rb -civ "app" $LOC/dedex $LOC/AndroidManifest.xml $LOC/IntentResults > $LOC/log/details.log
 # $INSTALLDIR/intentanalysis.rb -civ "app" $LOC/dedex $LOC/AndroidManifest.xml $LOC/IntentResults
